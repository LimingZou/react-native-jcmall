...
const dataSource = require("./data/order_detail");
...
export class OrderInfoInterface extends Interface {
  ...
  constructor(param) {
    super();
    try {
      this.info = new OrderInfoInfoInterface(dataSource.result.info);
      this.order_log = dataSource.result.order_log.map(function(item) {
