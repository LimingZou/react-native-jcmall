...
const dataSource = require("./data/orders.json");
const goodsInfo = require("./data/goodsInfo.json");
...
export class OrderStateNumInterface extends Interface {
  ...
  constructor(param) {
    ...
    try {
      ...
      throw new Exception(
        e,
        "OrderStateNumInterface interface attribute error"
      );
    }
  }
}
...
export class OrderListInterface extends Interface {
  ...
  constructor(param) {
    super();
    try {
      this.total_number = dataSource.result.total_number;
      this.list = dataSource.result.list.map(function(item) {
...
export class OrderListInfoInterface extends Interface {
  ...
  constructor(param) {
    ...
    try {
      ...
      throw new Exception(
        e,
        "OrderListInfoInterface interface attribute error"
      );
    }
  }
}
