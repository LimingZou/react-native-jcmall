...
// import { BuyApi } from "../../../services/api/buy";
...
//       };
//       const tokenData = await Fetch.externalLinkFetch(
//         `https://api.weixin.qq.com/sns/oauth2/access_token?${toQueryString(
//           tokenParams
//         )}`
//       );
...
//           lang: "zh_CN"
//         };
//         const userData = await Fetch.externalLinkFetch(
//           `https://api.weixin.qq.com/sns/userinfo?${toQueryString(
//             openidParams
//           )}`
//         );
//         return resolve({
